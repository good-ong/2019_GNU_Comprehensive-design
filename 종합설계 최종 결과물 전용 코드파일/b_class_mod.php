...
<div class="cate_center">
  ...
  <div id="right_content">
    <h2>수업자료 글수정하기</h2>
    <div id="write_area">
      <form action="class_modify_ok.php/<?php echo $board['class_idx']; ?>" method="post">
        <input type="hidden" name="class_idx" value="<?=$bno?>" />
        <div id="in_title">
          <textarea name="class_title" id="utitle" rows="1" cols="55" placeholder="제목" maxlength="100" required><?php echo $board['class_title']; ?></textarea>
        </div>
        ...
        <div class="wi_line"></div>
        <div id="in_content">
          <textarea name="class_desc" id="ucontent" placeholder="내용" required><?php echo $board['class_desc']; ?></textarea>
        </div>
        <div class="bt_se">
          <button type="submit">글 수정</button>
        </div>
      </form>
      <a href="b_class_view.php?idx=<?php echo $board['class_idx'];?>"><button>이전으로</button></a>
    </div>
  </div>
</div>
