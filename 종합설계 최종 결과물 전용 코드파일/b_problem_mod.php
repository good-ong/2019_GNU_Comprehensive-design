...
<div class="cate_center">
  ...
  <div id="right_content">
    <h2>문제모음 글수정하기</h2>
    <div id="write_area">
      <form action="problem_modify_ok.php/<?php echo $board['problem_idx']; ?>" method="post">
        <input type="hidden" name="problem_idx" value="<?=$bno?>" />
        <div id="in_title">
          <textarea name="problem_title" id="utitle" rows="1" cols="55" placeholder="제목" maxlength="100" required><?php echo $board['problem_title']; ?></textarea>
        </div>
        ...
        <div class="wi_line"></div>
        <div id="in_content">
          <textarea name="problem_desc" id="ucontent" placeholder="내용" required><?php echo $board['problem_desc']; ?></textarea>
        </div>
        <div class="bt_se">
          <button type="submit">글 수정</button>
        </div>
      </form>
      <a href="b_problem_view.php?idx=<?php echo $board['problem_idx'];?>"><button>이전으로</button></a>
    </div>
  </div>
</div>
